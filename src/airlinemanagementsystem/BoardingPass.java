...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        JLabel heading = new JLabel("INDIAN RAILWAYS");
        heading.setBounds(345, 10, 450, 35);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/irctc.png"));
